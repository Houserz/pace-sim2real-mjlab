...
def dobot_bounds(joint_count: int = 3) -> torch.Tensor:
    ...
    bounds[:joint_count, 1] = 1.0
    bounds[joint_count : 2 * joint_count, 1] = 5.0
    bounds[2 * joint_count : 3 * joint_count, 1] = 1
    bounds[3 * joint_count : 4 * joint_count, 0] = -0.0
    bounds[3 * joint_count : 4 * joint_count, 1] = 0.0
    bounds[-1, 1] = 5.0
    return bounds
